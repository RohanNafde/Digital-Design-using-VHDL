...
-- Design Ports Information
-- output_vector[0]	=>  Location: PIN_27,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_29,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|FF0|Q~0_combout\ : std_logic;
SIGNAL \input_vector[1]~input_o\ : std_logic;
SIGNAL \input_vector[1]~inputclkctrl_outclk\ : std_logic;
SIGNAL \add_instance|FF0|Q~q\ : std_logic;
SIGNAL \add_instance|FF1|Q~0_combout\ : std_logic;
SIGNAL \add_instance|FF1|Q~q\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|ALT_INV_y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|FF0|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|FF0|Q~0_combout\ = !\add_instance|FF0|Q~q\
...
-- pragma translate_on
PORT MAP (
	datac => \add_instance|FF0|Q~q\,
	combout => \add_instance|FF0|Q~0_combout\);
...
PORT MAP (
	...
	d => \add_instance|FF0|Q~0_combout\,
	clrn => \ALT_INV_input_vector[1]~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \add_instance|FF0|Q~q\);

-- Location: LCCOMB_X1_Y13_N28
\add_instance|FF1|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|FF1|Q~0_combout\ = \add_instance|FF1|Q~q\ $ (\add_instance|FF0|Q~q\)
...
-- pragma translate_on
PORT MAP (
	datac => \add_instance|FF1|Q~q\,
	datad => \add_instance|FF0|Q~q\,
	combout => \add_instance|FF1|Q~0_combout\);

-- Location: FF_X1_Y13_N29
\add_instance|FF1|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \input_vector[0]~inputclkctrl_outclk\,
	d => \add_instance|FF1|Q~0_combout\,
	clrn => \ALT_INV_input_vector[1]~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \add_instance|FF1|Q~q\);

-- Location: LCCOMB_X1_Y13_N16
\add_instance|y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|y~0_combout\ = (\add_instance|FF0|Q~q\ & \add_instance|FF1|Q~q\)
