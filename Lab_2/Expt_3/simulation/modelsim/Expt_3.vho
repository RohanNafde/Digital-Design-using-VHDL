...
-- Design Ports Information
-- input_vector[1]	=>  Location: PIN_141,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- output_vector[0]	=>  Location: PIN_48,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- output_vector[1]	=>  Location: PIN_43,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- input_vector[4]	=>  Location: PIN_47,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[8]	=>  Location: PIN_44,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- input_vector[5]	=>  Location: PIN_46,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|OR4|Y~0_combout\ : std_logic;
SIGNAL \input_vector[2]~input_o\ : std_logic;
SIGNAL \input_vector[6]~input_o\ : std_logic;
SIGNAL \add_instance|OR4|Y~1_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|OR4|Y~1_combout\,
	devoe => ww_devoe,
...
\add_instance|OR4|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR4|Y~0_combout\ = (!\input_vector[8]~input_o\ & !\input_vector[4]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|OR4|Y~0_combout\);
...
\add_instance|OR4|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR4|Y~1_combout\ = (\input_vector[0]~input_o\ & (((\input_vector[2]~input_o\) # (\input_vector[6]~input_o\)) # (!\add_instance|OR4|Y~0_combout\)))
...
PORT MAP (
	...
	datab => \add_instance|OR4|Y~0_combout\,
	datac => \input_vector[2]~input_o\,
	datad => \input_vector[6]~input_o\,
	combout => \add_instance|OR4|Y~1_combout\);
...
-- Equation(s):
-- \add_instance|OR3|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[3]~input_o\) # ((\input_vector[7]~input_o\) # (!\add_instance|OR4|Y~0_combout\))))
...
-- Equation(s):
-- \add_instance|OR2|Y~0_combout\ = (\input_vector[5]~input_o\) # ((\input_vector[6]~input_o\) # ((\input_vector[7]~input_o\) # (\input_vector[8]~input_o\)))
...
-- Equation(s):
-- \add_instance|OR2|Y~1_combout\ = (\add_instance|OR2|Y~0_combout\ & \input_vector[0]~input_o\)
