...
-- state_out[2]	=>  Location: PIN_114,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_instance|add_instance|FF2|Q~feeder_combout\ : std_logic;
SIGNAL \dut_input[1]~clkctrl_outclk\ : std_logic;
SIGNAL \dut_instance|add_instance|FF0|Q~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|FF0|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|FF2|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|D1~0_combout\ : std_logic;
...
SIGNAL \dut_instance|add_instance|FF1|ALT_INV_Q~q\ : std_logic;
...
\dut_instance|add_instance|FF1|ALT_INV_Q~q\ <= NOT \dut_instance|add_instance|FF1|Q~q\;
...
-- pragma translate_on
PORT MAP (
	i => \dut_instance|add_instance|FF1|ALT_INV_Q~q\,
	devoe => ww_devoe,
	o => ww_state_out(0));
...
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\dut_instance|add_instance|FF1|Q~q\))) # (!\datau[0]~0_combout\ & (((datau(0)))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|FF1|Q~q\,
	datac => datau(0),
...
\dut_instance|add_instance|FF2|Q~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FF2|Q~feeder_combout\ = \dut_instance|add_instance|FF1|Q~q\
...
PORT MAP (
	...
	combout => \dut_instance|add_instance|FF2|Q~feeder_combout\);
...
\dut_instance|add_instance|FF0|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FF0|Q~0_combout\ = !\dut_instance|add_instance|FF0|Q~q\
...
-- pragma translate_on
PORT MAP (
	datac => \dut_instance|add_instance|FF0|Q~q\,
	combout => \dut_instance|add_instance|FF0|Q~0_combout\);

-- Location: FF_X30_Y26_N13
\dut_instance|add_instance|FF0|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	d => \dut_instance|add_instance|FF0|Q~0_combout\,
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|FF0|Q~q\);
...
PORT MAP (
	clk => \dut_input[0]~clkctrl_outclk\,
	d => \dut_instance|add_instance|FF2|Q~feeder_combout\,
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	ena => \dut_instance|add_instance|FF0|Q~q\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|FF2|Q~q\);

-- Location: LCCOMB_X30_Y26_N24
\dut_instance|add_instance|D1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D1~0_combout\ = (!\dut_instance|add_instance|FF1|Q~q\ & !\dut_instance|add_instance|FF2|Q~q\)
...
PORT MAP (
	...
	combout => \dut_instance|add_instance|D1~0_combout\);
...
PORT MAP (
	clk => \dut_input[0]~clkctrl_outclk\,
	d => \dut_instance|add_instance|D1~0_combout\,
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	ena => \dut_instance|add_instance|FF0|Q~q\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
