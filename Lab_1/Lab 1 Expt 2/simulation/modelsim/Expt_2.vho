...
-- Design Ports Information
-- output_vector[0]	=>  Location: PIN_131,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- output_vector[1]	=>  Location: PIN_132,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- input_vector[0]	=>  Location: PIN_135,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \add_instance|NAND9|Y~0_combout\ = (\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\) # (\input_vector[2]~input_o\))) # (!\input_vector[1]~input_o\ & (\input_vector[0]~input_o\ & \input_vector[2]~input_o\))
...
-- Equation(s):
-- \add_instance|NAND8|Y~0_combout\ = \input_vector[1]~input_o\ $ (\input_vector[0]~input_o\ $ (\input_vector[2]~input_o\))
