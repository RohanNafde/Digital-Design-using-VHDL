...
-- Design Ports Information
-- output_vector[0]	=>  Location: PIN_25,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_132,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|NAND4|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|NAND4|Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|NAND4|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|NAND4|Y~0_combout\ = \input_vector[0]~input_o\ $ (\input_vector[1]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|NAND4|Y~0_combout\);
