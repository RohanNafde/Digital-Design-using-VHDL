...
-- pragma translate_on
PORT MAP (
	i => \add_instance|OR4|Y~0_combout\,
	devoe => ww_devoe,
...
-- Equation(s):
-- \add_instance|OR4|Y~0_combout\ = (\input_vector[2]~input_o\ & (\input_vector[0]~input_o\ & ((!\input_vector[1]~input_o\) # (!\input_vector[3]~input_o\)))) # (!\input_vector[2]~input_o\ & (\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\) # 
